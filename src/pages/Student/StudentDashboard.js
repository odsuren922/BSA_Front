        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (thesis?.data?.data?.thesis_cycle) {
                    ...
                    setGradingSchema(
                        thesis.data.data.thesis_cycle.grading_schema
                    );
                } else {
    ...
    return (
        <>
            <div style={{ padding: "20px" }}>
                <h3 className="mb-4">
                    Бакалаврын судалгааны ажлын удирдах систем
                </h3>
                ...
                <Row gutter={[16, 16]}>
                    ...
                    <Col span={8}>
                        <Card title="Оюутны мэдээлэл" bordered={false}>
                            <p>
                                <b>Нэр:</b>{" "}
                                {student.firstname || student.fnamem}{" "}
                                {student.lastname || student.lnamem}
                            </p>
                            <p>
                                <b>Хөтөлбөр:</b>{" "}
                                {student.program || student.pname}
                            </p>
                            <p>
                                <b>Sisi id :</b>{" "}
                                {student.num_id || student.cardnr}
                            </p>
                            <p>
                                <p>
                                    <b>Семестр:</b>{" "}
